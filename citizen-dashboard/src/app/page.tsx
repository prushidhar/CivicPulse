    ...
    <div className="flex flex-col items-center justify-center space-y-12">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full mt-12">
        <div className="bg-white p-6 rounded-xl shadow-sm border flex flex-col items-center text-center space-y-3">
          ...
          <h3 className="font-bold text-lg">{t("aiAnalysis")}</h3>
          <p className="text-gray-600 text-sm">{t("aiAnalysisSub")}</p>
        </div>
        <div className="bg-white p-6 rounded-xl shadow-sm border flex flex-col items-center text-center space-y-3">
          <div className="w-12 h-12 bg-green-100 text-green-600 rounded-full flex items-center justify-center">
            <MapPin className="w-6 h-6" />
          </div>
          <h3 className="font-bold text-lg">{t("preciseLoc")}</h3>
          <p className="text-gray-600 text-sm">{t("preciseLocSub")}</p>
        </div>
        <div className="bg-white p-6 rounded-xl shadow-sm border flex flex-col items-center text-center space-y-3">
          <div className="w-12 h-12 bg-purple-100 text-purple-600 rounded-full flex items-center justify-center">
            <ShieldCheck className="w-6 h-6" />
          </div>
          <h3 className="font-bold text-lg">{t("privacyFirst")}</h3>
          <p className="text-gray-600 text-sm">{t("privacyFirstSub")}</p>
        </div>
      </section>
    </div>
  );
