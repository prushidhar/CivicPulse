...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    loginStep1: "Enter your phone number to receive a secure code.",
    loginStep2: "We sent a code to your phone. Enter it below.",
    loginStep3: "Almost done! What should we call you?",
  ...
  es: {
    title: "CivicPulse BRICS",
    poweredBy: "Powered by Google Gemini 2.5",
    intelligentCivic: "Ciudadano Inteligente",
    infraForIndia: "Infraestructura para India.",
    heroDesc: "Reporte problemas por voz, texto o fotos en cualquier idioma regional.",
    reportAnIssue: "Reportar un Problema",
    govPortalAccess: "Acceso al Portal del Gobierno",
    trackStatus: "Rastrear Estado",
  ...
  hi: {
    ...
    loginStep1: "सुरक्षित कोड प्राप्त करने के लिए अपना फोन नंबर दर्ज करें।",
    loginStep2: "हमने आपके फोन पर एक कोड भेजा है। इसे नीचे दर्ज करें।",
    loginStep3: "लगभग हो गया! हम आपको क्या कह कर बुलाएँ?",
    phoneNumber: "फ़ोन नंबर",
    sendOtp: "OTP भेजें",
    digitCode: "4-अंकीय कोड",
    verifyCode: "कोड सत्यापित करें",
    changePhone: "फ़ोन नंबर बदलें",
    fullName: "पूरा नाम",
    completeVerify: "सत्यापन पूरा करें",
  },
  pt: {
    title: "CivicPulse BRICS",
    poweredBy: "Powered by Google Gemini 2.5",
    intelligentCivic: "Cidadão Inteligente",
    infraForIndia: "Infraestrutura para a Índia.",
    heroDesc: "Relate problemas por voz, texto ou fotos em seu idioma.",
    reportAnIssue: "Relatar um Problema",
    govPortalAccess: "Acesso ao Portal",
  ...
  ru: {
    title: "CivicPulse BRICS",
    poweredBy: "Powered by Google Gemini 2.5",
    intelligentCivic: "Умный Гражданин",
    infraForIndia: "Инфраструктура для Индии.",
    heroDesc: "Сообщайте о проблемах с помощью голоса, текста или фото.",
    reportAnIssue: "Сообщить о проблеме",
    govPortalAccess: "Правительственный портал",
    trackStatus: "Отследить статус",
  ...
  zh: {
    title: "CivicPulse BRICS",
    poweredBy: "Powered by Google Gemini 2.5",
    intelligentCivic: "智能公民",
    infraForIndia: "印度的基础设施。",
    heroDesc: "使用您的本地语言通过语音、文本或照片报告问题。",
    reportAnIssue: "报告问题",
    govPortalAccess: "政府门户网站",
    trackStatus: "跟踪状态",
    heroTitle: "用 AI 赋能社区",
  ...
  te: {
    ...
    loginStep1: "సురక్షిత కోడ్‌ను స్వీకరించడానికి మీ ఫోన్ నంబర్‌ను నమోదు చేయండి.",
    loginStep2: "మేము మీ ఫోన్‌కు ఒక కోడ్‌ను పంపాము. దానిని క్రింద నమోదు చేయండి.",
    loginStep3: "దాదాపు పూర్తయింది! మేము మిమ్మల్ని ఎలా పిలవాలి?",
    phoneNumber: "ఫోన్ నంబర్",
    sendOtp: "OTP పంపండి",
    digitCode: "4-అంకెల కోడ్",
    verifyCode: "కోడ్‌ను ధృవీకరించండి",
    changePhone: "ఫోన్ నంబర్ మార్చండి",
    fullName: "పూర్తి పేరు",
    completeVerify: "ధృవీకరణను పూర్తి చేయండి",
  },
  ta: {
    title: "CivicPulse BRICS",
    poweredBy: "Powered by Google Gemini 2.5",
    intelligentCivic: "ஸ்மார்ட் சிட்டிசன்",
    infraForIndia: "இந்தியாவிற்கான உள்கட்டமைப்பு.",
    heroDesc: "உங்கள் பிராந்திய மொழியில் குரல், உரை அல்லது புகைப்படங்கள் மூலம் சிக்கல்களைப் புகாரளிக்கவும்.",
    reportAnIssue: "சிக்கலைப் புகாரளி",
    govPortalAccess: "அரசு போர்ட்டல் அணுகல்",
    trackStatus: "நிலையை கண்காணிக்க", heroTitle: "AI மூலம் சமூகங்களை மேம்படுத்துதல்", heroSub: "உள்ளூர் பிரச்சனைகளை புகாரளித்து, அதன் தீர்வை கண்காணிக்கவும்.",
  ...
  bn: {
    title: "CivicPulse BRICS",
    poweredBy: "Powered by Google Gemini 2.5",
    intelligentCivic: "স্মার্ট সিটিজেন",
    infraForIndia: "ভারতের জন্য পরিকাঠামো।",
    heroDesc: "আপনার আঞ্চলিক ভাষায় ভয়েস, টেক্সট বা ছবির মাধ্যমে সমস্যার রিপোর্ট করুন।",
    reportAnIssue: "সমস্যার রিপোর্ট করুন",
    govPortalAccess: "সরকারি পোর্টাল অ্যাক্সেস",
    trackStatus: "অবস্থা ট্র্যাক করুন", heroTitle: "এআই দ্বারা সম্প্রদায়কে ক্ষমতায়ন", heroSub: "স্থানীয় সমস্যার রিপোর্ট করুন এবং সমাধানের অগ্রগতি ট্র্যাক করুন।",
  ...
  mr: {
    ...
    poweredBy: "Powered by Google Gemini 2.5",
    intelligentCivic: "स्मार्ट नागरिक",
    infraForIndia: "भारतासाठी पायाभूत सुविधा.",
    heroDesc: "तुमच्या प्रादेशिक भाषेत आवाज, मजकूर किंवा फोटोंद्वारे समस्या नोंदवा.",
    reportAnIssue: "समस्या नोंदवा",
    govPortalAccess: "सरकारी पोर्टल ऍक्सेस",
    trackStatus: "स्थिती ट्रॅक करा", heroTitle: "AI द्वारे समुदायांचे सक्षमीकरण", heroSub: "स्थानिक समस्या नोंदवा आणि ट्रॅक करा.",
  ...
  gu: {
    title: "CivicPulse BRICS",
    poweredBy: "Powered by Google Gemini 2.5",
    intelligentCivic: "સ્માર્ટ નાગરિક",
    infraForIndia: "ભારત માટે ઈન્ફ્રાસ્ટ્રક્ચર.",
    heroDesc: "તમારી પ્રાદેશિક ભાષામાં અવાજ, ટેક્સ્ટ અથવા ફોટા દ્વારા સમસ્યાઓ નોંધાવો.",
    reportAnIssue: "સમસ્યા નોંધાવો",
    govPortalAccess: "સરકારી પોર્ટલ ઍક્સેસ",
    trackStatus: "સ્થિતિ ટ્રૅક કરો", heroTitle: "AI દ્વારા સમુદાયોનું સશક્તિકરણ", heroSub: "સ્થાનિક સમસ્યાઓ નોંધાવો અને ઉકેલને ટ્રૅક કરો.",
  ...
  ar: {
    title: "CivicPulse BRICS",
    poweredBy: "Powered by Google Gemini 2.5",
    intelligentCivic: "مواطن ذكي",
    infraForIndia: "البنية التحتية للهند.",
    heroDesc: "قم بالإبلاغ عن المشكلات عبر الصوت أو النص أو الصور بلغتك الإقليمية.",
    reportAnIssue: "الإبلاغ عن مشكلة",
    govPortalAccess: "الوصول إلى البوابة الحكومية",
    trackStatus: "تتبع الحالة", heroTitle: "تمكين المجتمعات باستخدام الذكاء الاصطناعي", heroSub: "قم بالإبلاغ عن المشكلات المحلية وتتبع حلها.",
