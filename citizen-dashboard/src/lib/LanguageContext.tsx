...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    poweredBy: "Powered by Google Gemini 1.5",
  ...
  te: {
    ...
    reportAnIssue: "Report an Issue",
    govPortalAccess: "Gov Portal Access",
    trackStatus: "Track Status", heroTitle: "AI తో కమ్యూనిటీల సాధికారత", heroSub: "CivicPulse BRICS అనేది AI-ఆధారిత పబ్లిక్-ఇన్వెస్ట్‌మెంట్ మరియు నిర్ణయ-మద్దతు వేదిక. స్థానిక సమస్యలను నివేదించండి మరియు పరిష్కారాన్ని ట్రాక్ చేయండి.",
