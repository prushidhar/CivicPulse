                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="bg-white dark:bg-background rounded-lg p-4 border border-purple-200 dark:border-purple-800">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Recommended Action</span>
                          </div>
                          <p className="text-sm text-foreground leading-relaxed">
                            {r.transcript && r.transcript.includes('Recommended Action:')
                              ? r.transcript.split('Recommended Action:')[1]?.trim()
                              : 'No recommendation yet. Will be generated by Gemini AI when the request is processed.'}
                          </p>
                        </div>
