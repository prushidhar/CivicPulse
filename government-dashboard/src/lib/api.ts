...
export const api = {
  ...
  decideRecommendation: async (id: string, decision: 'accepted' | 'rejected' | 'edited', reason: string) => fetchWithAuth(`/recommendations/${id}/decision`, { method: 'POST', body: JSON.stringify({ decision, reason, reviewer: 'Admin' }) }),
